const PLATFORM_CONFIG = {
    ...
    perplexity: {
      ...
      textAreaSelector: "textarea, div[class*='col-start-1 col-end-4 pb-sm overflow-hidden relative flex h-full w-full'], form textarea, form [role='textbox']",
    ...
    mistral: {
      ...
      textAreaSelector: "textarea, div[class='relative overflow-hidden mb-2 min-h-10 w-full'], div.ProseMirror, [contenteditable='true']",
