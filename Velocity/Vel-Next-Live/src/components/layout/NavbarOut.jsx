...
const NavbarOut = ({ isLoggedIn: propIsLoggedIn }) => {
      ...
      <div className="bg-white w-full">
        <div className="w-full mx-auto px-4 bg-white">
          <nav className="w-full z-20">
            <div
              className="w-full max-w-[1800px] mx-auto bg-white border-2 border-black rounded-xl overflow-hidden my-4"
              style={{ boxShadow: "4px 4px 2px black" }}
            >
              {/* Mobile view */}
              <div className="md:hidden w-full flex items-center justify-between py-4 px-6">
                <Link
                  href="/"
                  onClick={() =>
              ...
              {/* Desktop view */}
              <div className="hidden md:grid w-full items-center py-3 sm:py-6 px-6 sm:px-12 md:px-16 grid-cols-[auto,1fr,auto]  bg-white">
                {/* Logo - Left Column */}
                <div className="flex items-center">
                  ...
                  >
                    <div className="flex items-center cursor-pointer">
                      ...
                      />
                      <span
                        className="ml-2 font-dm-sans text-xl sm:text-3xl md:text-4xl lg:text-5xl"
                        style={{
                          fontWeight: "600",
                          color: "#152A32",
                        }}
                ...
                {/* Center Column - Empty for NavbarOut */}
                ...
                <div className="flex items-center">
                  ...
                  <div className="hidden md:flex items-center">
                    {!isLoggedIn ? (
                      ...
                      >
                        <UserRound className="border border-black rounded-full w-12 h-12 lg:w-16 lg:h-16 p-1 text-black hover:bg-gray-100 transition-colors" />
                      </button>
                    )}
                  </div>
                </div>
              ...
              {isMenuOpen && (
                <div
                  className="md:hidden absolute right-0 top-[60px] bg-white border-2 border-black rounded-xl p-4 mr-4 z-50"
                  style={{ boxShadow: "4px 4px 2px black" }}
                >
